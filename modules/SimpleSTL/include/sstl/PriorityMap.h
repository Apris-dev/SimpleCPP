...
>
struct TPriorityMap : TAssociativeContainer<std::map<TKeyType, TValueType>> {

	using Super = TAssociativeContainer<std::map<TKeyType, TValueType>>;
	...
	virtual typename std::map<TKeyType, TValueType>::node_type extract(const TKeyType& key) override {
